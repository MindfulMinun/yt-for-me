...
(function (root, factory) {
  ...
  var errors = (_errors = {}, _defineProperty(_errors, 0x0100, "Request error (HTTP 400)"), _defineProperty(_errors, 0x0101, "Empty request"), _defineProperty(_errors, 0x0102, "Not found"), _defineProperty(_errors, 0x0103, "Refused to serve cross-origin request"), _defineProperty(_errors, 0x0104, "Too many requests (HTTP 429)"), _defineProperty(_errors, 0x0105, "You're a bot"), _defineProperty(_errors, 0x0300, "Client-side error"), _defineProperty(_errors, 0x0301, "Assertion failed"), _defineProperty(_errors, 0x0302, "YouTube video ID invalid"), _defineProperty(_errors, 0x0304, "YouTube playlist ID invalid"), _defineProperty(_errors, 0x0400, "API error"), _defineProperty(_errors, 0x0401, "Failed to retrieve video information via ytdl-core"), _defineProperty(_errors, 0x0402, "Failed to retrieve playlist information"), _defineProperty(_errors, 0x0403, "Search failed"), _defineProperty(_errors, 0x0410, "Download progress ID invalid"), _defineProperty(_errors, 0x0411, "Invalid output format"), _defineProperty(_errors, 0x0412, "No input files provided"), _defineProperty(_errors, 0x0500, "Server error"), _defineProperty(_errors, 0x0501, "Unexpected server error"), _defineProperty(_errors, 0x0502, "Temporary outage (HTTP 503)"), _defineProperty(_errors, 0x0503, "Conversion error"), _defineProperty(_errors, 0x0504, "Format download error"), _defineProperty(_errors, 0xba11ad, "Service discontinued"), _defineProperty(_errors, 0x0961, "L is real"), _defineProperty(_errors, 0x0539, "Debugging"), _errors);
  return {
    lang: 'en-US',
    welcome: {
    ...
    errors: {
      ...
      error400: function error400(err) {
        return "\n                <div class=\"error\">\n                    <h2>Ah snap,, an error occurred!!1!!</h2>\n                    <p>Error: ".concat(errors[err.errCode] || err.error || '¿¡unknown error¿? (this is probably bad)', " (code 0x").concat((err.errCode || 0).toString(16), ")</p>\n                    ").concat(err.error ? "\n                        <p>The server said: <samp>".concat(err.error, "</samp></p>\n                    ") : '', "\n                    <p>Reload the page.</p>\n                </div>\n            ");
      },
